...
app.use(
  require("express-favicon")(path.resolve(__dirname, "./assets/beaver.ico"))
);
...
app.use(
  config.server.staticUrl,
  express.static(path.resolve(__dirname, "./assets/sites/bliss/static"))
);
app.use(
  "/broadcaster/static",
  express.static(path.resolve(__dirname, "./assets/sites/broadcaster/static"))
);
app.use(
  "/superfamous/static",
  express.static(path.resolve(__dirname, "./assets/sites/superfamous/static"))
);
app.use(
  "/verdict/static",
  express.static(path.resolve(__dirname, "./assets/sites/verdict/static"))
);
app.use(
  "/beaver/static",
  express.static(path.resolve(__dirname, "./assets/sites/beaver"))
);
app.use(
  "/blendful/static",
  express.static(path.resolve(__dirname, "./assets/sites/blendful/static"))
);
app.use(
  "/digitalbits/static",
  express.static(path.resolve(__dirname, "./assets/sites/digitalbits/static"))
);
app.use(
  "/jido/static",
  express.static(path.resolve(__dirname, "./assets/sites/jido/static"))
);
app.use(
  "/outpost/static",
  express.static(path.resolve(__dirname, "./assets/sites/outpost/static"))
);
app.use(
  "/flyingcarpet/static",
  express.static(path.resolve(__dirname, "./assets/sites/flyingcarpet/static"))
);
app.use(
  "/junior/static",
  express.static(path.resolve(__dirname, "./assets/sites/junior/static"))
);
app.use(
  "/veridium/static",
  express.static(path.resolve(__dirname, "./assets/sites/veridium/static"))
);
app.use(
  "/slice/static",
  express.static(path.resolve(__dirname, "./assets/sites/slice/static"))
);
app.use(
  "/mevu/static",
  express.static(path.resolve(__dirname, "./assets/sites/mevu/static"))
);
app.use(
  "/cryptagami/static",
  express.static(path.resolve(__dirname, "./assets/sites/cryptagami/static"))
);
app.use(
  "/asq/static",
  express.static(path.resolve(__dirname, "./assets/sites/asq/public"))
);
app.use(config.server.staticUrl, function (req, res, next) {
